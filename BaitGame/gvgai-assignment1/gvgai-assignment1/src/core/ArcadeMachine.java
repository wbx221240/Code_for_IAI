...
public class ArcadeMachine
{
    ...
    protected static AbstractPlayer createController(String playerName, StateObservation so) throws RuntimeException
    {
        ...
        try
        {
            ...
            Class<? extends AbstractPlayer> controllerClass = Class.forName(playerName).asSubclass(AbstractPlayer.class);//the
            // function of forname is to match the class that fit the Agent name we give.
